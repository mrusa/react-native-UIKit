...
const ArticleList = ({
  ...
  <ListView
    ...
    renderRow={(rowData, i) =>
      ...
      >
        <View enableEmptySections={false} style={[styles.row, { paddingVertical: 15, paddingHorizontal: gutter }]} >
          <View style={[styles.cell]}>
            <View>
              ...
              <Text style={[styles.text, { color: titleColor, fontSize: titleSize, marginBottom: 5 }]}>
                {truncate(rowData.title, { 'length': 85, 'separator': /,? +/})}
              </Text>
            </View>
