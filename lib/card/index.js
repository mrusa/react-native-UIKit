...
const Card = ({src, title, link, radius, gutter, onPress, marginBottom}) => (
  <View style={[styles.cardShadow, {marginHorizontal: gutter, borderRadius: radius, marginBottom: marginBottom}]}>
